    ...
    <div>
      <div className = 'form'>
        ...
        <form>
          ...
          <TextField type = 'password' label ='Подтвердите пароль' name = 'password' style = {{ display: 'block', marginBottom: '20px' }} fullWidth  onChange = {handleVerifyPassword}></TextField>
